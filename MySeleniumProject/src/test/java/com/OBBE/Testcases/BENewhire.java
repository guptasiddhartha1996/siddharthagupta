...
public class BENewhire extends BaseTest {

	
	@Test
	public void newhire(String cltid,String usname,String pasw, int count, String env) throws InterruptedException {
...
//		String cid = prop.getProperty("clientid");
		...
		try {
	        ...
	        FileOutputStream file = new FileOutputStream(System.getProperty("user.dir")+"\\TestData\\"+env+" BE New Hire.xlsx");
	        workbook.write(file); 
	        file.close(); 
	        System.out.println("Data Copied to Excel");
	   
//	        FileOutputStream file = new FileOutputStream(System.getProperty("user.dir")+"\\TestData\\BE New Hire.xlsx"); 
//	        workbook.write(file); 
//	        file.close(); 
//	        System.out.println("Data Copied to Excel");
	        switch (env) {
