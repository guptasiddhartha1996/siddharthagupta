...
public class OnboardingPageObjects2 extends BaseTest {
	
	public OnboardingPageObjects2(WebDriver driver) {
	...
	@FindBy(xpath="//span[@title='Welcome']")
	...
	public String beforeid="tdxspan43v1x3";
	...
	public void electronicConsent() throws InterruptedException {
		try {
	...
	public void i9SectionOne(String lastname, String firstname, String bdate, String sosn, String add, String cty,String stat, String zp, String routing_number) throws InterruptedException {
		try {
			//I9 Section 1 Page
			WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(20));
			JavascriptExecutor executor = (JavascriptExecutor)driver;
	...
	public void directDeposit() throws InterruptedException {
		try {
			//Direct Deposit Page
			WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(20));
			JavascriptExecutor executor = (JavascriptExecutor)driver;
	...
	public void Disability() throws InterruptedException {
		try {
			//Disability Page
			JavascriptExecutor executor = (JavascriptExecutor)driver;
			Thread.sleep(2000);
	...
	public void veteran() throws InterruptedException {
		try {
			//Veteran Page
			Thread.sleep(3000);
	...
	public void onboardingsummary() throws InterruptedException {
		try {
			//Onboarding Summary
			Thread.sleep(2000);
			ctn_btn.click();
